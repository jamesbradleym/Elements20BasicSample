...
namespace Elements20BasicSample
{
    public class Function
    {
        ...
        private IModelStore<Elements20BasicSampleInputs> store;

        public async Task<Elements20BasicSampleOutputs> Handler(Elements20BasicSampleInputs args, ILambdaContext context)
        {
            ...
            { 
                ...
                {
                    this.store = new S3ModelStore<Elements20BasicSampleInputs>(RegionEndpoint.GetBySystemName("us-west-1"));
                }
                else
                {
                    this.store = new UrlModelStore<Elements20BasicSampleInputs>();
                }
            }

            var l = new InvocationWrapper<Elements20BasicSampleInputs,Elements20BasicSampleOutputs> (store, Elements20BasicSample.Execute);
