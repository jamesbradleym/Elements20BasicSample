...
namespace Elements20BasicSample
{
    ...
    public  class Elements20BasicSampleInputs : S3Args
    
    {
        [Newtonsoft.Json.JsonConstructor]
        
        public Elements20BasicSampleInputs(double @parameter, Overrides @overrides, string bucketName, string uploadsBucket, Dictionary<string, string> modelInputKeys, string gltfKey, string elementsKey, string ifcKey):
        base(bucketName, uploadsBucket, modelInputKeys, gltfKey, elementsKey, ifcKey)
        {
            var validator = Validator.Instance.GetFirstValidatorForType<Elements20BasicSampleInputs>();
            if(validator != null)
            {
